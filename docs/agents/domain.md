...
If the concept isn't in the glossary yet, reconsider whether new terminology is necessary or note a real gap for `/domain-modeling`.

## Flag ADR conflicts

If output contradicts an existing ADR, surface it explicitly rather than silently overriding the recorded decision.
